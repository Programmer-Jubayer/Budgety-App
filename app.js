...
var UIController =(function() {
      ...
      displayBudget : function(obj) {
         ...
         obj.TotalBudget > 0 ? type = 'inc' : type = 'exp';
          ...
          if (obj.TotalPercentage >= 0) {
              document.querySelector(DOMStrings.percentage).textContent = obj.TotalPercentage + "%";
          } else {
  ...
  displayMonth: function() {
      ...
      document.querySelector(DOMStrings.date).textContent = date + " " + month[thisMonth] + ", " + year;
  },
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  document.querySelector(DOM.totalExpense).textContent = 0;
  document.querySelector(DOM.percentage).textContent = 0;
  ...
  var updatePercentages = function() {
      ...
      // 2. Return percentages form the budget controller
